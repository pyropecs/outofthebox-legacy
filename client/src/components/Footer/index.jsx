        ...
        <div class="md:flex md:flex-wrap md:-mx-4 py-6 md:pb-12">
          <div class="footer-info lg:w-1/3 md:px-4">
            <h4 class="text-white text-2xl mb-4">
              OUTB stories and making their life to change.
            </h4>
            <p class="text-gray-400">
              We have sucessfully shared the stories to the experts
            </p>
            <div class="mt-4">
          ...
          <div class="md:w-1/3 md:px-4 md:text-center mt-12 lg:mt-0">
            ...
            <button class="bg-green-600 text-white hover:bg-green-700 rounded py-2 px-6 md:px-12 transition-colors duration-300">
              Explore
            </button>
          </div>
        </div>
